...
The core modules exposes the [`OmhUserProfile`](https://openmobilehub.github.io/react-native-omh-auth/docs/api/interfaces/openmobilehub_auth_core.OmhUserProfile#properties) type which you might find useful when working in a TypeScript React Native app.
